...
T01 = [-1*sin(q1), -1*cos(q1), 0; cos(q1), -1*sin(q1), 0; 0, 0, 1];
T02 = [sin(q1+q2), cos(q1+q2), -1*r*sin(q1); -1*cos(q1+q2), sin(q1+q2), r*cos(q1); 0, 0, 1];
T03 = [sin(q1+q3), cos(q1+q3), -1*r*sin(q1); -1*cos(q1+q3), sin(q1+q3), r*cos(q1); 0, 0, 1];
...
pm2 = pm2(1:2, :);
% center of mass
pcm = (Mh*pMh + Mt*pMt + m*pm1 + m*pm2) / (2*m + Mh + Mt);
% end of swing leg
P2 = T02*[r; 0; 1];
P2 = P2(1:2, :);
